                    ...
                    {activeFilter === 'LIVE' && (
                        <div className="p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700">
                            ...
                            {order.status === OrderStatus.READY_FOR_PICKUP && (
                                <div className="text-center text-xs font-bold text-gray-500 dark:text-gray-400 animate-pulse">
                                    Waiting for Delivery Partner...
                                </div>
                            )}
                             {order.status === OrderStatus.OUT_FOR_DELIVERY && (
                                <div className="text-center text-xs font-bold text-indigo-600 dark:text-indigo-400">
                                    Order is on the way
                                </div>
                            )}
                        </div>
